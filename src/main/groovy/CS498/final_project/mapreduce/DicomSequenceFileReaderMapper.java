 ...
 *
 */
public class DicomSequenceFileReaderMapper extends Mapper<byte[],byte[],Text,Text> {
    ...
    protected void map(byte[] key, byte[] value,Context context) throws IOException, InterruptedException {
       ...
       //To Do insert logic to pre-process dicom file and to insert it into Hbase;
        try{
        dataset = ByteUtilities.byteArrayToDicomAttributes(value);  
        ...
        persister = new DicomFilePersister(value);
